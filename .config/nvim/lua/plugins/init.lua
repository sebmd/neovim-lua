return {
    ...
    { "gruvbox-community/gruvbox", enabled = true },
    { "kristijanhusak/vim-hybrid-material", enabled = true },
    { "lighthaus-theme/vim-lighthaus", enabled = true },
    { "sainnhe/everforest", enabled = true },
    { "sainnhe/gruvbox-material", enabled = true },
    { "srcery-colors/srcery-vim", enabled = true },
    { "zekzekus/menguless", enabled = true },
    { "EdenEast/nightfox.nvim", enabled = true },
    { "folke/twilight.nvim", enabled = true },
    { "yamatsum/nvim-cursorline", enabled = false },
    { "kyazdani42/nvim-web-devicons", enabled = true },
    { "lukas-reineke/indent-blankline.nvim", enabled = true },
    { "nvim-lualine/lualine.nvim", dependencies = "kyazdani42/nvim-web-devicons", enabled = true },
    ...
    { "oberblastmeister/neuron.nvim", enabled = true },
    { "dhruvasagar/vim-dotoo", enabled = true },
    ...
    { "romgrk/barbar.nvim", dependencies = "nvim-web-devicons", enabled = true },
    { "steelsojka/pears.nvim", enabled = true },
    { "airblade/vim-rooter", enabled = false },
    { "folke/which-key.nvim", enabled = true },
    { "mvllow/modes.nvim", enabled = true },
}
